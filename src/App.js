...
import {
  MDBBtn, MDBInput, MDBModal, MDBModalBody, MDBModalHeader, MDBModalFooter, MDBIcon, MDBContainer, MDBRow,
  MDBCol
} from "mdbreact"
...
export default class App extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("https://api.hgbrasil.com/weather?woeid=455827")
      .then(res => {
        const resp = res.data
        this.setState({ clima: resp })
        console.log(resp)
      })
  }
          ...
          <MDBCol md="3">
            ...
            <h1 className="my-3">
              <MDBRow>
                ...
                <MDBCol xs="9">{/* this.state.clima.results.description */}</MDBCol>
              </MDBRow>
              <MDBRow>
                <MDBCol xs="3" className="text-center">
                  <MDBIcon icon="thermometer-three-quarters" fixed />
                </MDBCol>
                <MDBCol xs="9">{/* this.state.clima.results.temp */}°C</MDBCol>
              </MDBRow>
            </h1>
            <p>
